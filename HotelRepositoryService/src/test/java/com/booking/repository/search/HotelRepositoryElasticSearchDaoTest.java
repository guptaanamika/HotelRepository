...
import com.booking.repository.dao.impl.HotelRepositoryElasticSearchDao;
import com.booking.repository.entity.Address;
import com.booking.repository.entity.HotelInfo;

@ContextConfiguration("classpath:spring/application-context.xml")
@RunWith(SpringJUnit4ClassRunner.class)
public class HotelRepositoryElasticSearchDaoTest {

	@Autowired
	private HotelRepositoryElasticSearchDao dao;
	...
	public void insertTest() {
		...
		Assert.assertEquals(hotelInfo.getName(), hotelInfo1.getName());
	}
